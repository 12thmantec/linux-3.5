...
#define V4L2_CID_TV_WAIT_VSYNC		(V4L2_CID_EXYNOS_BASE + 57)
...
#define V4L2_CID_CAMERA_SCENE_MODE		(V4L2_CID_FIMC_IS_BASE+700+70)
enum v4l2_exynos_scene_mode
{
	SCENE_MODE_BASE,
	SCENE_MODE_NONE,
	SCENE_MODE_PORTRAIT,
...
#define V4L2_CID_CAMERA_FLASH_MODE		(V4L2_CID_FIMC_IS_BASE+700+71)
...
#define V4L2_CID_CAMERA_BRIGHTNESS		(V4L2_CID_FIMC_IS_BASE+700+72)
enum v4l2_ev_mode {
	EV_MINUS_4	= -4,
	EV_MINUS_3	= -3,
	EV_MINUS_2	= -2,
...
#define V4L2_CID_CAMERA_WHITE_BALANCE	(V4L2_CID_FIMC_IS_BASE+700+73)
enum v4l2_wb_mode {
...
#define V4L2_CID_CAMERA_EFFECT			(V4L2_CID_FIMC_IS_BASE+700+74)
...
#define V4L2_CID_CAMERA_ISO				(V4L2_CID_FIMC_IS_BASE+700+75)
enum v4l2_iso_mode {
	ISO_AUTO = 0,
	ISO_50,
	ISO_100,
...
#define V4L2_CID_CAMERA_METERING			(V4L2_CID_FIMC_IS_BASE+700+76)
...
#define V4L2_CID_CAMERA_CONTRAST			(V4L2_CID_FIMC_IS_BASE+700+77)
...
#define V4L2_CID_CAMERA_SATURATION		(V4L2_CID_FIMC_IS_BASE+700+78)
...
#define V4L2_CID_CAMERA_SHARPNESS		(V4L2_CID_FIMC_IS_BASE+700+79)
...
#define V4L2_CID_CAMERA_TOUCH_AF_START_STOP		(V4L2_CID_FIMC_IS_BASE+700+82)
enum v4l2_touch_af {
	TOUCH_AF_STOP = 0,
	TOUCH_AF_START,
	TOUCH_AF_MAX,
...
#define V4L2_CID_CAMERA_FLASH_START                 (V4L2_CID_PRIVATE_BASE + 150)
#define V4L2_CID_CAMERA_FLASH_STOP                  (V4L2_CID_PRIVATE_BASE + 151)
...
#define V4L2_CID_CAMERA_SET_AUTO_FOCUS		(V4L2_CID_FIMC_IS_BASE+700+93)
...
#define V4L2_CID_CAMERA_AEAWB_LOCK_UNLOCK		(V4L2_CID_FIMC_IS_BASE+700+95)
...
#define V4L2_CID_CAMERA_OBJECT_POSITION_X	(V4L2_CID_FIMC_IS_BASE+700+97)
#define V4L2_CID_CAMERA_OBJECT_POSITION_Y	(V4L2_CID_FIMC_IS_BASE+700+98)
#define V4L2_CID_CAMERA_FOCUS_MODE		(V4L2_CID_FIMC_IS_BASE+700+99)
enum v4l2_focusmode {
	FOCUS_MODE_AUTO = 0,
	FOCUS_MODE_MACRO,
...
#define V4L2_CID_CAMERA_CAF_START_STOP	(V4L2_CID_FIMC_IS_BASE+700+102)
...
#define V4L2_CID_CAMERA_FRAME_RATE			(V4L2_CID_FIMC_IS_BASE+700+104)
...
#define V4L2_CID_CAMERA_ANTI_BANDING					(V4L2_CID_FIMC_IS_BASE+700+105)
